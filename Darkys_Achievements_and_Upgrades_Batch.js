{
	...
	Link to the Armful Collection of Upgrades: https://pastebin.com/eFPWvzga
	Link to the Achievements and Upgrades Batch: 
	Enjoy!

													~ ~ ~ CHANGELOG ~ ~ ~

													Version 1.5.2 [01/02/20]

	• Happy New Year, just a month late!
	• This update doesn't add new content, it just changes a few things regarding the ASS.
	• Thanks go out to Aktan and G lander once again.
	• Also the bakery has been baking something for quite a while.
	• It's been long in the baking, a few times it was close to being done but it never quite was.
	• But now it should be ready and you can finally taste the new baked goodies yourself.
	• Here's your coupon code: eFPWvzga
...

{
	...
	Game.Notify("Darky's Achievements and Upgrades Batch", " <b>71</b> new Achievements and <b>34</b> new Upgrades have been added, enjoy and thank you for using my mods!", [3, 4, "https://i.imgur.com/Fn7YXtZ.png"]);
