	/*
										...
										+ + + + DARKY'S ARMFUL COLLECTION OF UPGRADES + + + +

														Version 1.0

	Currently contains 34 new upgrades.
	Thanks to Aktan and G lander for GREATLY helping out with the code, without them this mod would most likely not be here right now.
	Link to my Achievement Package: https://pastebin.com/Qpv3rGm5
	
	Enjoy!

													~ ~ ~ CHANGELOG ~ ~ ~

													Version 1.0 [02/02/20]

	• Finally, after a long time of trying and failing its here: Darky's Armful Collection of Upgrades!
	• First created back in August 19, 2018. I've tried to make it work by myself a few times but never could figure out how to actually go about this.
	• A year later I've tried it again, it must be possible to make an Upgrade mod for Cookie Clicker, right?
	• So i sat there, looking through the code once more and testing out a few things until FINALLY i at least managed to make the generic Building Upgrades work except for the Cursor and the mouse.
	• I asked Aktan for help with those two Upgrades as well as for helping me make the Save System work, so you don't have to re-buy every upgrade again everytime you load the mod.
	• Sometime in January we finally got the Save System working as well as the 2 Upgrades! A few finishing touches had to be made to the Save System though apparently.
	• And now finally i can share this mod with everyone, so glad its finally done and out!
	• My main focus is still on my Achievement Package however. I would love to bring in some original upgrades as well (there is one in this mod but currently unavailable to get because it has no function) but for that I would always have to ask either Aktan or G lander for help because making an Upgrade mod is pretty hard, at least for me.
	• Anyway I'm done, now I patiently wait for the next Update to work on new Achievements again.
...

{
	...
	Game.customCrate = Game.customCrate.concat([
		...
		new TieredUpgrade('Granny talk','Grandmas are <b>twice</b> as efficient.<q>Only a few have survived.</q>','Grandma',12),
		...
		new TieredUpgrade('Chocolate chip seeds','Farms are <b>twice</b> as efficient.<q>Makes sense, right?</q>','Farm',12),
		new TieredUpgrade('Bulldoughzer','Farms are <b>twice</b> as efficient.<q>A modified tractor pretty much, doing its job.</q>','Farm',13),
		new TieredUpgrade('Omegadrill','Mines are <b>twice</b> as efficient.<q>It\'s coming in late but we go it.</q>','Mine',12),
		...
		new TieredUpgrade('Pumping out new workers','Factories are <b>twice</b> as efficient.<q>Yes, we no longer need the birds and the bees, we can just create life itself!</q>','Factory',12),
		new TieredUpgrade('Rainbow factory','Factories are <b>twice</b> as efficient.<q>Dreams come true, little one.</q>','Factory',13),
		new TieredUpgrade('Baking the dough','Banks are <b>twice</b> as efficient.<q>Instead of making the bucks.</q>','Bank',12),
		...
		new TieredUpgrade('Cookie cults','Temples are <b>twice</b> as efficient.<q>Every sunday they meet to bake in secret.</q>','Temple',12),
		...
		new TieredUpgrade('Trix™️','Wizard towers are <b>twice</b> as efficient.<q>Brand cookies which taste pretty bad but not taken off the market for some reason. These darn wizards and their silly magic, keeping their brand cookies alive with their magic!</q>','Wizard tower',12),
		...
		new TieredUpgrade('Hyperspeed','Shipments are <b>twice</b> as efficient.<q>HYPE, HYPE, HYPE, HYPE!</q>','Shipment',12),
		...
		new TieredUpgrade('The way we make golden cookies','Alchemy labs are <b>twice</b> as efficient.<q>[REDACTED]</q>','Alchemy lab',12),
		...
		new TieredUpgrade('Portal to nowhere','Portals are <b>twice</b> as efficient.<q>A quiet place to store the cookies. I don\'t know why you would want to do that though.</q>','Portal',12),
		...
		new TieredUpgrade('Year of the weekly months without the days','Time machines are <b>twice</b> as efficient.<q>Counting the hourly seconds by minutes.</q>','Time machine',12),
		...
		new TieredUpgrade('Bake matter','Antimatter condensers are <b>twice</b> as efficient.<q>Just a bunch of tiny balls during scientific baking.</q>','Antimatter condenser',12),
		...
		new TieredUpgrade('Shiny!!','Prisms are <b>twice</b> as efficient.<q>Let\'s baking!</q>','Prism',12),
		new TieredUpgrade('Colorful arrangement','Prisms are <b>twice</b> as efficient.<q>Also known as: Rainbow.</q>','Prism',13),
		new TieredUpgrade('Casino fever','Chancemakers are <b>twice</b> as efficient.<q>A dangerous place for your wallet has become heaven on earth for it.</q>','Chancemaker',12),
		...
		new TieredUpgrade('Big brain time','Fractal engines are <b>twice</b> as efficient.<q>Think thonk.</q>','Fractal engine',12),
		new TieredUpgrade('Nora','Fractal engines are <b>twice</b> as efficient.<q>Fractals are her specialty.</q>','Fractal engine',13),
		new TieredUpgrade('Darky can\'t actually code','Javascript consoles are <b>twice</b> as efficient.<q>He just happened to be smart enough to make both an achievement and upgrade mod for Cookie Clicker.</q>','Javascript console',12),
