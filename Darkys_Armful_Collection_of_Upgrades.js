{
    ...
    Game.customCrate = Game.customCrate.concat([
        ...
        // new TieredUpgrade(
        //     "Bing bang bingo",
        //     "Grandmas are <b>twice</b> as efficient.<q>You would think this is some kind of upgraded and hot, new bingo game but you'd be wrong my friend. This is a SOAP for GRANNIES!</q>",
        //     "Grandma",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Bulldoughzer",
        //     "Farms are <b>twice</b> as efficient.<q>A modified tractor pretty much, doing its job.</q>",
        //     "Farm",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Miner's delight",
        //     "Mines are <b>twice</b> as efficient.<q>Who would've thought that a child's weird mixture of random things could turn out to be an excellent energy drink for miners and miners only. Too bad we can't share the recipe with anyone else.</q>",
        //     "Mine",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Rainbow factory",
        //     "Factories are <b>twice</b> as efficient.<q>Dreams come true, little one.</q>",
        //     "Factory",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Cookie credit cards",
        //     "Banks are <b>twice</b> as efficient.<q>They say doing this is a bad idea but come on, we are converting everything into cookies now so why not?</q>",
        //     "Bank",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Baking bible",
        //     "Temples are <b>twice</b> as efficient.<q>Ancient stories about old ladies baking for the poor and getting murdered for doing so. Or maybe they just died of old age.</q>",
        //     "Temple",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Fixing misspellings in spells",
        //     "Wizard towers are <b>twice</b> as efficient.<q>How are spells supposed to work if said spells have misspellings in them?</q>",
        //     "Wizard tower",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "10 seconds flat",
        //     "Shipments are <b>twice</b> as efficient.<q>Zap Zap, to the end of the universe and back.</q>",
        //     "Shipment",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Eggheads",
        //     "Alchemy labs are <b>twice</b> as efficient.<q>Crack them open, use them for baking.</q>",
        //     "Alchemy lab",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Port Al",
        //     "Portals are <b>twice</b> as efficient.<q>Al Port, claims he discovered the portals and named them after himself. Staff is no longer allowed to bring in homeless people.</q>",
        //     "Portal",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Decaying decades",
        //     "Time machines are <b>twice</b> as efficient.<q>Each decade, we start to rot more. We stink, get dirty. Even cookies aren't save from this fate.</q>",
        //     "Time machine",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "NERDS: Cookies",
        //     "Antimatter condensers are <b>twice</b> as efficient.<q>Not the greatest idea we had.</q>",
        //     "Antimatter condenser",
        //     13
        // ),
        ...
        //     "Prisms are <b>twice</b> as efficient.<q>Also known as: Rainbow.</q>",
        //     "Prism",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Odd-ifiers",
        //     "Chancemakers are <b>twice</b> as efficient.<q>No longer shall you ask \"What are the odds?\" with this!</q>",
        //     "Chancemaker",
        //     13
        // ),
        new TieredUpgrade(
        ...
        // new TieredUpgrade(
        //     "Nora",
        //     "Fractal engines are <b>twice</b> as efficient.<q>Fractals are her specialty.</q>",
        //     "Fractal engine",
        //     13
        // ),
        new TieredUpgrade(
        ...
        //     "Javascript consoles are <b>twice</b> as efficient.<q>I am so tiered of this.</q>",
        //     "Javascript console",
        //     13
        // ),
    ]);
    ...
    // -------------------------------------------------------------------
    // Game.mouseCps = Game.mouseCps
    //     .toString()
    //     .split("Octillion fingers')) add+=	5000000;")
    //     .join(
    //         "Octillion fingers')) add+=	5000000;\nif (Game.Has('Nonillion fingers')) add+=	50000000; //Darky's upgrade package injection"
    //     )
    //     .split("Plasmarble mouse')) add+=Game.cookiesPs*0.01;")
    //     .join(
    //         "Plasmarble mouse')) add+=Game.cookiesPs*0.01;\nif (Game.Has('Loyalystic mouse')) add+=Game.cookiesPs*0.01; //Darky's upgrade package injection"
    //     );
    // Game.Objects["Cursor"].cps = Game.Objects["Cursor"].cps
    //     .toString()
    //     .split("Octillion fingers')) add+=	5000000;")
    //     .join(
    //         "Octillion fingers')) add+=	5000000;\nif (Game.Has('Nonillion fingers')) add+=	50000000; //Darky's upgrade package injection"
